...
class TypeTechnic(models.Model):
    """Тип техники"""
    name = models.CharField(max_length=100, verbose_name='type', **NULLABLE)  # `Имя типа техники
    description = models.CharField(max_length=150, verbose_name='description', **NULLABLE)  # Описание
...
class Department(models.Model):
    ...
    name = models.CharField(max_length=100, verbose_name='type', **NULLABLE)  # Имя подразделения
    description = models.CharField(max_length=150, verbose_name='description', **NULLABLE)  # Описание
...
class Technic(models.Model):
    ...
    department = models.ForeignKey(Department, on_delete=models.CASCADE, verbose_name='Подразделение')  # Подразделение техники
